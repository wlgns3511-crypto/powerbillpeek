...
export const metadata: Metadata = {
  ...
  description: "Terms of service for PowerBillPeek.",
...
export default function TermsPage() {
  return (
    <article className="prose prose-slate max-w-3xl mx-auto">
      ...
      <p>
        Welcome to PowerBillPeek. By accessing or using our website at powerbillpeek.com, you agree to be bound by these
      ...
      <p>
        PowerBillPeek provides electricity rate data, utility cost comparisons, and power bill calculators for
        informational and educational purposes only. You may use the website for personal, non-commercial purposes.
        The information provided should not be the sole basis for energy purchasing or relocation decisions.
      </p>
      ...
      <p>
        ...
        sourced from publicly available datasets, including the U.S. Energy Information Administration. Users should
        independently verify any information before making decisions based on it. Actual electricity rates may vary
        based on your specific utility provider, plan, and usage patterns.
      </p>

      <h2 className="text-xl font-semibold mt-8 mb-3">Intellectual Property</h2>
      <p>
        The content, design, and layout of this website are the property of PowerBillPeek and are protected by copyright
      ...
      <p>
        To the fullest extent permitted by law, PowerBillPeek shall not be liable for any indirect, incidental, special,

...
export const metadata: Metadata = {
  ...
  description: "Privacy policy for PowerBillPeek.",
...
export default function PrivacyPage() {
  return (
    <article className="prose prose-slate max-w-3xl mx-auto">
      ...
      <p>
        PowerBillPeek (&quot;we,&quot; &quot;us,&quot; or &quot;our&quot;) operates the website powerbillpeek.com. This
      ...
      <p>
        ...
        <a href="https://www.google.com/settings/ads" className="text-amber-600 hover:underline" target="_blank" rel="noopener noreferrer">
          Google Ads Settings
        </a>{" "}or visit{" "}
        <a href="https://www.aboutads.info/choices/" className="text-amber-600 hover:underline" target="_blank" rel="noopener noreferrer">www.aboutads.info</a>.
      </p>
